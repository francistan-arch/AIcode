...
class PacoService {
  ...
  async createPaymentSession({
    ...
    // Actual 2C2P PACO Direct Gateway Request
    try {
      console.log(`[2C2P PACO API] Silently posting RS256 signed payment request to: ${this.apiUrl}`);
      ...
      console.error('[2C2P PACO Direct API Error]', error.response?.data || error.message);
